...
export function mockVisionAnalysis() {
  return {
    sceneType: '古装权谋 · 现代灵魂',
    objects: ['范闲独白', '鉴查院腰牌', '京都城门', '庆帝的冷笑', '监察使令牌'],
    emotionTone: '紧张→释然',
    recommendedCategory: ['3C 手机', '文旅', '游戏'],
    insertTiming: '稍后（情绪回落时）',
    confidence: 0.87,
    reasoning: '当前场景处于朝堂博弈高潮，情绪张力较高，建议等待情绪回落后插入广告以避免打断沉浸体验。',
  };
}
