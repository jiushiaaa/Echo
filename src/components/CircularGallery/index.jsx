...
class App {
  constructor(container, { items, bend, textColor = '#ffffff', borderRadius = 0, font = 'bold 30px sans-serif', scrollSpeed = 2, scrollEase = 0.05, autoSpeed = 1 } = {}) {
    this.container = container;
    this.scrollSpeed = scrollSpeed;
    this.autoSpeed = autoSpeed;
    // 初始偏移足够大，确保画廊一开始就填满视口（避免从空白慢慢滚入）
